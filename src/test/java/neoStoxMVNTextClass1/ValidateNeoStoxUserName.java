 ...
 String s="ssss";
	  ...
	  public void launchNeoStoxApp() throws IOException
	{
	  ...
	  public void loginToNeoStox() throws EncryptedDocumentException, IOException, InterruptedException 
	 {
		 ...
		 sinpage.mobileNofieldsendkey(UtlityClass.readDataFromExcel(0, 0));
		 Thread.sleep(1000);
		 sinpage.signInbuttonclick();
		 
		 UtlityClass.implicitWait(1000, driver);
		 pass.PUTpasswordField(UtlityClass.readDataFromExcel(0, 1));
  ...
  {
	 // Assert.fail();
	Assert.assertEquals(pop.getActualUserName(),UtlityClass.readDataFromExcel(0, 2),"actual and expected test is not match then test case is fail") ;
